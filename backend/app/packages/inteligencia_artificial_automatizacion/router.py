...
from app.packages.inteligencia_artificial_automatizacion.modules.notificaciones.routers.cu12_notificaciones_ia import router as cu12_router_ia
from app.packages.inteligencia_artificial_automatizacion.modules.notificaciones.routers.cu12_notificaciones import router as cu12_router
...
router.include_router(cu12_router_ia, tags=["IA - Notificaciones"])
